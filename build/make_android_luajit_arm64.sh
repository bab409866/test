...
ANDROID_NDK=/root/work/build_xlua_with_libs/android-ndk-r15c
ANDROID_TOOLCHAIN_NAME=/root/work/build_xlua_with_libs/android-ndk-r15c/toolchains/x86_64-4.8
...
cmake -DUSING_LUAJIT=ON -DANDROID_ABI=arm64-v8a -DCMAKE_TOOLCHAIN_FILE=$ANDROID_NDK/build/cmake/android.toolchain.cmake -DANDROID_TOOLCHAIN_NAME=arm-linux-androideabi-clang -DANDROID_NATIVE_API_LEVEL=android-21 ../ -DCMAKE_BUILD_TYPE=Release
cd "$DIR"
...
cmake -DUSING_LUAJIT=ON -DANDROID_ABI=armeabi-v7a -DCMAKE_TOOLCHAIN_FILE=../cmake/android.toolchain.cmake -DANDROID_TOOLCHAIN_NAME=arm-linux-androideabi-4.9 -DANDROID_NATIVE_API_LEVEL=android-21 ../ -DCMAKE_BUILD_TYPE=Release
cd "$DIR"
...
cmake -DUSING_LUAJIT=ON -DANDROID_ABI=x86 -DCMAKE_TOOLCHAIN_FILE=$ANDROID_NDK/build/cmake/android.toolchain.cmake -DANDROID_TOOLCHAIN_NAME=x86-clang -DANDROID_NATIVE_API_LEVEL=android-21 ../ -DCMAKE_BUILD_TYPE=Release
cd "$DIR"
